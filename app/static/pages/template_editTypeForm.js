  ...
  builder: {
    ...
    multiple: {
      ...
      components: {
        ...
        datagrid: true,
        editgrid: true,
        NumberArray_BarPlot: true,
        NumberArray_BothPlots: true,
        NumberArray_NoPlots: true,
        NumberArray_ScatterPlot: true,
        TensionPlots: true,
        tree: true,
      },
    },
...
$(function () {
  ...
  Formio.createForm(document.getElementById('metaform'), metaschema)
    .then((createdForm) => {
      ...
      $.get(`/json/${collection}/singleType/${formId}`, ChangeRecordData)
        .fail(function () {
...
function SubmitData(submission) {
  $.ajax({
    ...
    method: 'post',
    url: `/json/${collection}/singleType/${formId}`,

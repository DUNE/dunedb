  ...
  "components": [
  {
    ...
    
    {
      "components": [
      {
        ...
        "widget": "choicesjs",
        "tooltip": "Select the component types that this test type will apply to. Leave empty to apply to all component types.",
        "tableView": true,
        "tableView": true,
        "multiple": true,
        "dataSrc": "url",
    ...
    
    {
      "components": [
      {
        ...
        "tooltip": "Component or job types that this test relates to. Use the 'Trash' tag to remove this test type from public view.",
        "tableView": false,
        "storeas": "array",
        "key": "tags",
        "type": "tags",

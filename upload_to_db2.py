...
if __name__ == "__main__":
  ...
  data_to_send = { 'form_id': 'apitest', 'data': {'big_array': [random.random() for _ in range(10000)]}}

  record_id = '5ed9b63a39819b3c9d06cff3'

  def test_send(): 
  	retval = send_data("apitest",data_to_send)
  	print(retval)
  	record_id = retval['_id']

  def test_get():  get_data("apitest",'5ed9b63a39819b3c9d06cff3')

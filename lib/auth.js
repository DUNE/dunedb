...
router.get('/callback', function (req, res, next) {
  passport.authenticate('auth0', function (err, user, info) {
    ...
    // console.log(chalk.red("/callback authenticate callback"));
    // console.log(chalk.red("user",JSON.stringify(user,null,2)));
    // console.log(chalk.red("info",JSON.stringify(info,null,2)));
...
router.post('/machineAuthenticate', limiter, async (req,res)=>{
...
module.exports = function(app) {
    ...
    // Configure Passport.
    console.log(config.my_url+"/callback");
    ...
    var strategy = new Auth0Strategy(
      ...
      function (accessToken, refreshToken, extraParams, profile, done) {
        ...
        // console.log(chalk.red("profile",JSON.stringify(profile,null,2)));
        // console.log(chalk.red("token",JSON.stringify(decoded,null,2)));
    ...
    passport.serializeUser(function (user, done) {
      console.log(chalk.red('serializeUser',user.user_id));
      done(null, user);
    });
    ...
    app.use('/api',rate_limiter,verify_m2m_middleware);

...
const default_permissions      = global.config.default_permissions || ['components:view', 'tests:view', 'forms:view', 'jobs:view'];
...
function hasPermission(req,scope_required)
{
  ...
  var scopes = userPermissions(req);
...
function checkPermission(scope_required) {
  return function(req,res,next)
  {
    ...
    return res.status(400).render('permissionsError.pug',{scope_required:scope_required,user_scopes:userPermissions(req)})
  }
}

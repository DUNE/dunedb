...
TestsModule.prototype.listRecent = async function(formId,N,skip)
  {
    ...
    var formNames = await Forms.getListOfForms(this._formCollection);
    console.log(formNames);
    for(var form of p) form.formName = formNames[form.formId];
...
TestsModule.prototype.search = async function(txt,match)
{
  var matchobj= match || {};
  console.log("TestsModule",matchobj);
  var result = [];
  if(txt) {

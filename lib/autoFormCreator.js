...
function autoFormCreator(documents, recurse)
{
  ...
  for(var path in paths) {
    ...
    if(mytype === 'array') {
      ...
      if(arrtype==='object') {
        ...
        // recurse.
        component.components = autoFormCreator(allvalues,true).components;
      } else {
        continue;
      }
      ...
      component.components = autoFormCreator(values,true).components;
    ...
    component.key = patharr[patharr.length-1];
    component.label = deCamelCase(component.key);
...
if (typeof require !== 'undefined' && require.main === module) 
{
  ...
  var docs = [
    { a: 1, b: "one", c:'2012-01-04', d: longstring, e: 'eb86e550-a9c1-11ea-bbcc-8dda7beedcce' },
    { a: 2.3, b: "two", c:'05/04/19', d: longstring,   e: 'eb000000-a9c1-11ea-bbcc-8dda7beedcce' },
    { a: "NaN", b: "two", c:'05/04/19', d: longstring,   e: 'eb000000-a9c1-11ea-bbcc-8dda7beedcce' },
    {
      obj: { o1: 1, o2: "two" },
  ...
  console.log(JSON.stringify(autoFormCreator(docs),null,2));
}
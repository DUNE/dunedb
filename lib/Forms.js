...
async function save(input,collection,req)
{
  ...
  console.log('new form record',result.ops[0]);
...
async function list(collection)
{
  ...
  // console.log("Forms::list()",collection, //JSON.stringify(retval,null,2)
  //   );
  return retval;
}
...
Cache.add("all_tags",async function() {
    ...
    delete tokens.Trash;
    console.log("all_tags run");
    console.log("all_tags",JSON.stringify(tags_lists));
    console.log("tags:",Object.keys(tokens))

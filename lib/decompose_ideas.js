...
function decompose(record, requisition, instance)
{
  ...
  for(var subcomponent_name in requisition.subcomponents) {
    ...
    for(var field in subcomponent.component_properties) {
      console.log("field",field,subcomponent.component_properties[field]);
...
function runDecompositionFunction(decomp_function, record) {
  ...
  var createTest = function(datarec) 
  {
    ...
    if(!new_test.form_id) throw new Error("No form_id provided to createTest");
  ...
  console.log('decomp function returned ',retval);
  console.log("psuedoconsole returned",psuedoConsole);

  console.log("------ new components -------");
  console.log(JSON.stringify(created_components,null,2));
  console.log("------ new tests -------");
  console.log(JSON.stringify(created_tests,null,2));
}

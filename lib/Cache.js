...
class Cache
{
	...
	async current() {
		...
		// return this._cached;
		// console.log("Cache: getting current",this._name)
		...
		console.log("Cache: database entry exists but is out of date.",rec.date,this._cacheTime)
...
class CacheManager
{
   ...
   invalidate(name) {
	...
	regenerateAll() {
		// console.log("CacheManager::regenerateAll")
